...
@section('pageSubTitle', 'Tambah Vendor || Individual')

@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Vendor</h5>
            <form class="row g-3" method="POST" action="{{ route('vendor.store') }}" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control form-control-sm" name="posisi_pekerjaan" value="{{ old('posisi_pekerjaan') }}">
                </div>
