...
@section('pageSubTitle', 'Edit Vendor || Individual')
...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3" method="POST" action="{{ route('vendor.update', $individual->id) }}" enctype="multipart/form-data">
            ...
            <div class="col-12 text-end">
                <form action="{{ route('vendor.destroy', $individual->id) }}" method="POST" class="pt-1">
                    @csrf
                    @method('DELETE')
